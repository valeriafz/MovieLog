      ...
      <div className="bg-base max-w-xl w-full flex flex-col items-center border border-base text-base backdrop-blur-md rounded-3xl border shadow-xl p-6 md:p-8 z-10">
        ...
        <form className="space-y-6" onSubmit={handleRegister}>
          <div className="max-w-xl flex flex-col items-center">
            ...
            />
            <button
              className="cursor-pointer w-full max-w-md bg-orange-700 hover:bg-orange-800 text-white font-semibold py-3 px-3 rounded-3xl transition-all shadow-lg mt-2"
              type="submit"
            >
              Register
            </button>
            <Link className="mt-3 hover:text-white" href="/auth/login">
